...
impl App {
    ...
    /// Returns true if the URI is a root-level scope (e.g. "ctx://resources")
    fn is_root_scope_uri(uri: &str) -> bool {
        let stripped = uri.trim_start_matches("ctx://").trim_end_matches('/');
