...
from atom_ctx.models.vlm.registry import DEFAULT_AZURE_API_VERSION
...
class OpenAIDenseEmbedder(DenseEmbedderBase):
    ...
    def __init__(
        ...
        Args:
            ...
            api_key: API key, if None will read from env vars (ATOM_CTX_EMBEDDING_API_KEY or OPENAI_API_KEY)
