...
"""
Base parser interface for AtomCtx document processing.
...
class ResourceNode:
    ...
    async def get_detail_content_async(self, temp_uri: str) -> str:
        ...
        try:
            return await get_ctx_fs().read_file(file_uri)
        except Exception:
            return ""
...
class ParseResult:
    ...
    temp_dir_path: Optional[str] = None  # e.g., "/tmp/atom_ctx_parse_a1b2c3d4"
