...
"""
Directory pre-scan validation module for AtomCtx.
...
from atom_ctx.parse.parsers.constants import IGNORE_DIRS
from atom_ctx.parse.parsers.upload_utils import is_text_file
from atom_ctx.parse.registry import ParserRegistry, get_registry
...
def _should_skip_directory(
    ...
    ignore_dirs: directory names, or relative paths (relative to root).
                 ...
                 - Relative path (e.g. "parse/", "./storage/vectordb", "atom_ctx/parse"): skip when dir's path matches.
    """
