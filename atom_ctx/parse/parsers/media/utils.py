...
"""Media-related utilities for AtomCtx."""
...
def get_media_base_uri(media_type: str) -> str:
    ...
    Returns:
        Base URI like "ctx://resources/images/20250219"
    """
    ...
    return f"ctx://resources/{media_dir}/{date_str}"
...
async def generate_image_summary(
    ...
    try:
        # Read image bytes
        image_bytes = await ctx_fs.read_file_bytes(image_uri, ctx=ctx)
