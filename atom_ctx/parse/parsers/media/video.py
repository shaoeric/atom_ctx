...
from atom_ctx.parse.parsers.media.constants import VIDEO_EXTENSIONS
from atom_ctx_cli.utils.config.parser_config import VideoConfig
...
class VideoParser(BaseParser):
    ...
    async def parse(self, source: Union[str, Path], instruction: str = "", **kwargs) -> ParseResult:
        ...
        await ctx_fs.write_file_bytes(f"{root_dir_uri}/{original_filename}", video_bytes)
    ...
    async def _generate_semantic_info(
        self, node: ResourceNode, description: str, ctx_fs, has_key_frames: bool
    ):
        """
