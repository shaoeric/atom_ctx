...
from atom_ctx.parse.parsers.code.ast.languages.base import LanguageExtractor
from atom_ctx.parse.parsers.code.ast.skeleton import CodeSkeleton
...
_EXTRACTOR_REGISTRY: Dict[str, tuple] = {
    "python": ("atom_ctx.parse.parsers.code.ast.languages.python", "PythonExtractor", {}),
    "javascript": (
        "atom_ctx.parse.parsers.code.ast.languages.js_ts",
        "JsTsExtractor",
        {"lang": "javascript"},
    ),
    "typescript": (
    ...
    "java": ("atom_ctx.parse.parsers.code.ast.languages.java", "JavaExtractor", {}),
    "cpp": ("atom_ctx.parse.parsers.code.ast.languages.cpp", "CppExtractor", {}),
    "rust": ("atom_ctx.parse.parsers.code.ast.languages.rust", "RustExtractor", {}),
    "go": ("atom_ctx.parse.parsers.code.ast.languages.go", "GoExtractor", {}),
    "csharp": ("atom_ctx.parse.parsers.code.ast.languages.csharp", "CSharpExtractor", {}),
}
