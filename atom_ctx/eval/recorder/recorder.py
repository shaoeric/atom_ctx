...
"""
IO Recorder implementation for AtomCtx evaluation.
"""
...
class IORecorder:
    ...
    Usage:
        ...
        recorder.record_fs("read", {"uri": "ctx://..."}, b"content", 10.5)
...
def create_recording_agfs_client(agfs_client: Any, record_file: Optional[str] = None) -> Any:
    ...
    Usage:
        from atom_ctx.eval.recorder import init_recorder, create_recording_agfs_client
        ...
        # Use in VikingFS
        ctx_fs = VikingFS(...)
        ctx_fs.agfs = recording_client
    """
    from atom_ctx.eval.recorder.recording_client import RecordingAGFSClient
