...
"""
RAG Query Pipeline for AtomCtx evaluation.
"""
...
class RAGQueryPipeline:
    ...
    This pipeline:
    1. Adds documents/code to AtomCtx
    ...
    def _get_client(self):
        """Lazy initialization of AtomCtx client."""
        if self._client is None:
            ...
            self._client = ctx.SyncAtomCtx(path=self.data_path, config=config)
            self._client.initialize()
            logger.info("AtomCtx client initialized")
        return self._client
    ...
    def add_documents(
        ...
        """
        Add document directories/files to AtomCtx.
    ...
    def add_code_repos(
        ...
        """
        Add code repositories to AtomCtx.
