...
"""
Dataset generator for AtomCtx evaluation.
"""
...
class DatasetGenerator:
    """
    Generates evaluation datasets from AtomCtx resources.
    """
    ...
    def __init__(self, llm: Optional[Any] = None):
        ...
        Args:
            llm: LLM instance to use for question/answer generation.
                 Should be an AtomCtx VLMProcessor or similar.
        """
        self.llm = llm

    async def generate_from_ctx_path(
        self,
        path: str,
        count: int = 5,
        scope: str = "resources",
        ...
        """
        get_ctx_fs()
        uri_base = f"ctx://{scope}/{path.lstrip('/')}"
