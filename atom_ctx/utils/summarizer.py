...
from atom_ctx.storage.queuefs import SemanticMsg, get_queue_manager
    ...
    async def summarize(
        ...
        **kwargs,
        ...
        for uri, temp_uri in zip(resource_uris, temp_uris):
            ...
            if uri.startswith("ctx://memory/"):
                context_type = "memory"
            elif uri.startswith("ctx://agent/skills/"):
                context_type = "skill"
