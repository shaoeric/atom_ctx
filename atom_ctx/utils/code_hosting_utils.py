...
def parse_code_hosting_url(url: str) -> Optional[str]:
    ...
    Args:
        url: Code hosting URL like https://github.com/volcengine/atom-ctx
             or git@github.com:volcengine/AtomCtx.git

    Returns:
        org/repo path like "volcengine/AtomCtx" or None if not a valid
        code hosting URL
    """
