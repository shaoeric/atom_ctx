...
"""
Intent analyzer for AtomCtx retrieval.
...
from atom_ctx_cli.retrieve.types import ContextType, QueryPlan, TypedQuery
...
class IntentAnalyzer:
    ...
    async def analyze(
        ...
        # Call LLM
        response = await get_atom_ctx_config().vlm.get_completion_async(prompt)
