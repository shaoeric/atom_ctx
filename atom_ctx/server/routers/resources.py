...
"""Resource endpoints for AtomCtx HTTP Server."""
...
from atom_ctx.server.telemetry import run_operation
...
class AddResourceRequest(BaseModel):
    ...
    Attributes:
        ...
        temp_file_id: Temporary upload id returned by /api/v1/resources/temp_upload.
            Either path or temp_file_id must be provided.
        to: Target URI for the resource (e.g., "ctx://resources/my_resource").
...
async def temp_upload(
    ...
    """Upload a temporary file for add_resource or import_ctxpack."""
