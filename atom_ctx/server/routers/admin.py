...
"""Admin endpoints for AtomCtx multi-tenant HTTP Server."""

from fastapi import APIRouter, Path, Request
from pydantic import BaseModel

from atom_ctx.server.auth import require_role
...
async def delete_account(
    ...
    for prefix in account_prefixes:
        try:
            await ctx_fs.rm(prefix, recursive=True, ctx=cleanup_ctx)
