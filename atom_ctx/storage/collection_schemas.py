...
"""
Collection schema definitions for AtomCtx.

Provides centralized schema definitions and factory functions for creating collections,
similar to how init_ctx_fs encapsulates VikingFS initialization.
"""
...
from atom_ctx.storage.errors import CollectionNotFoundError
...
class CollectionSchemas:
    ...
    def context_collection(name: str, vector_dim: int) -> Dict[str, Any]:
        ...
        fields = [
            ...
            # 推导规则：
            #   - URI 以 ctx://agent/skills 开头 → "skill"
...
class TextEmbeddingHandler(DequeueHandlerBase):
    ...
    def _initialize_embedder(self, config: "AtomCtxConfig"):
