...
from atom_ctx.storage.vectordb.collection.collection import ICollection
...
from atom_ctx.storage.vectordb.collection.volcengine_clients import (
    VIKING_DB_VERSION,
    ClientForConsoleApi,
    ClientForDataApi,
)
...
class VolcengineCollection(ICollection):
    ...
    def _sanitize_uri_value(v: Any) -> Any:
        """Remove ctx:// prefix and normalize to /... format; return None for empty values"""
