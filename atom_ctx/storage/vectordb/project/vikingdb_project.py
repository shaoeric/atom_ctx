...
from atom_ctx.storage.vectordb.collection.collection import (
    Collection,
    load_collection_class,
)
from atom_ctx.storage.vectordb.collection.vikingdb_clients import (
    VIKINGDB_APIS,
    VikingDBClient,
)
...
def get_or_create_vikingdb_project(
    ...
    collection_class_path = config.get(
        "CollectionClass",
        "atom_ctx.storage.vectordb.collection.vikingdb_collection.VikingDBCollection",
    )
...
class VikingDBProject:
    ...
    def __init__(
        ...
        collection_class_path: str = "atom_ctx.storage.vectordb.collection.vikingdb_collection.VikingDBCollection",
