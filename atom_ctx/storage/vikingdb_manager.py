...
from atom_ctx.storage.expr import FilterExpr
from atom_ctx.storage.queuefs.embedding_msg import EmbeddingMsg
from atom_ctx.storage.queuefs.embedding_queue import EmbeddingQueue
...
class VikingDBManager(VikingVectorIndexBackend):
    ...
    async def close(self) -> None:
        ...
        try:
            ...
            # and should be managed by the creator (AtomCtxService).
