...
1. Start AtomCtx server (default: `http://127.0.0.1:1933`)
...
4. In **Settings**, paste your AtomCtx `X-API-Key` and click **Save** (or press Enter).
`X-API-Key` is configured in the web UI Settings panel and stored in browser session storage.

## Startup parameters

- `--atom_ctx-url` (default `http://127.0.0.1:1933`)
