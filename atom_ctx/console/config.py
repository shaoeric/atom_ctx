...
"""Configuration for the standalone AtomCtx console service."""
...
class ConsoleConfig:
    ...
    host: str = "127.0.0.1"
    port: int = 8020
    atom_ctx_base_url: str = "http://127.0.0.1:1933"
    ...
    def normalized_base_url(self) -> str:
        ...
        return self.ctx_base_url.rstrip("/")
...
def load_console_config(
    *,
    ...
    return ConsoleConfig(
        host=host,
        port=port,
        atom_ctx_base_url=atom_ctx_base_url,
