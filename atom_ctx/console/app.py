...
"""FastAPI app for the standalone AtomCtx console service."""
...
async def _forward_request(request: Request, upstream_path: str) -> Response:
    """Forward the incoming request to AtomCtx upstream."""
    ...
    try:
        ...
        return _error_response(
            ...
            message=f"Failed to reach AtomCtx upstream: {exc}",
        )
...
def _create_proxy_router() -> APIRouter:
    ...
    @router.post("/ctx/resources/temp_upload")
    ...
    @router.post("/ctx/admin/accounts")
    ...
    @router.delete("/ctx/admin/accounts/{account_id}")
    ...
    @router.post("/ctx/admin/accounts/{account_id}/users")
    ...
    @router.delete("/ctx/admin/accounts/{account_id}/users/{user_id}")
    ...
    @router.put("/ctx/admin/accounts/{account_id}/users/{user_id}/role")
    ...
    @router.post("/ctx/admin/accounts/{account_id}/users/{user_id}/key")
    ...
    @router.post("/ctx/sessions/{session_id}/messages")
    ...
    @router.post("/ctx/sessions/{session_id}/commit")
...
def create_console_app(
    ...
    app = FastAPI(
        title="AtomCtx Console",
        description="Standalone console for AtomCtx HTTP APIs",
        version="0.1.0",
        lifespan=lifespan,
    )
    ...
    async def healthz():
        return {"status": "ok", "service": "atom_ctx-console"}
