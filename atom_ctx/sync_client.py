...
"""
Synchronous AtomCtx client implementation.
"""
...
class SyncAtomCtx:
    """
    SyncAtomCtx main client class (Synchronous).
    Wraps AsyncAtomCtx with synchronous methods.
    """

    def __init__(self, **kwargs):
        self._async_client = AsyncAtomCtx(**kwargs)
    ...
    def add_resource(
        ...
        **kwargs,
        ...
        """Add resource to AtomCtx (resources scope only)
    ...
    def export_ctxpack(self, uri: str, to: str) -> str:
        """Export .ctxpack file"""
        return run_async(self._async_client.export_ctxpack(uri, to))

    def import_ctxpack(
        self, file_path: str, target: str, force: bool = False, vectorize: bool = True
    ) -> str:
        """Import .ctxpack file (triggers vectorization by default)"""
        return run_async(self._async_client.import_ctxpack(file_path, target, force, vectorize))
    ...
    def glob(self, pattern: str, uri: str = "ctx://") -> Dict:
    ...
    def reset(cls) -> None:
        ...
        return run_async(AsyncAtomCtx.reset())
