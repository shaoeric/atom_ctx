...
from atom_ctx.service import AtomCtxService
from atom_ctx.telemetry import TelemetryRequest
from atom_ctx.telemetry.execution import (
...
class LocalClient(BaseClient):
    """Local Client for AtomCtx (embedded mode).
    ...
    @property
    def service(self) -> AtomCtxService:
    ...
    async def add_message(
        ...
        from atom_ctx.message.part import Part, TextPart, part_from_dict
    ...
    async def export_ctxpack(self, uri: str, to: str) -> str:
        ...
        return await self._service.pack.export_ctxpack(uri, to, ctx=self._ctx)
    ...
    async def import_ctxpack(
        ...
        """Import .ctxpack file."""
        return await self._service.pack.import_ctxpack(
