...
if TYPE_CHECKING:
    from atom_ctx.session.memory.merge_op.patch_handler import MemoryPatchHandler
...
class PatchOp(MergeOpBase):
    ...
    def apply(self, current_value: Any, patch_value: Any) -> Any:
        ...
        # For string fields
        from atom_ctx.session.memory.merge_op.patch_handler import apply_str_patch
