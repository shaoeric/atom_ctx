...
class UserIdentifier(object):
    ...
    def _agent_space_source(self) -> str:
        ...
        try:
            ...
            scope_mode = get_atom_ctx_config().memory.agent_scope_mode
        except Exception:
    ...
    def memory_space_uri(self) -> str:
        return f"ctx://agent/{self.agent_space_name()}/memories"

    def work_space_uri(self) -> str:
        return f"ctx://agent/{self.agent_space_name()}/workspaces"
