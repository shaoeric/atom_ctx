...
class EmbeddingModelConfig(BaseModel):
    ...
    def get_effective_dimension(self) -> int:
        ...
        if provider == "voyage":
            from atom_ctx.models.embedder.voyage_embedders import (
...
class EmbeddingConfig(BaseModel):
    ...
    def _create_embedder(
        ...
        """
        from atom_ctx.models.embedder import (
            GeminiDenseEmbedder,
            JinaDenseEmbedder,
    ...
    def get_embedder(self):
        ...
        """
        from atom_ctx.models.embedder import CompositeHybridEmbedder
        from atom_ctx.models.embedder.base import DenseEmbedderBase, SparseEmbedderBase
