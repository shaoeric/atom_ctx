...
AGFS_CONF = AGFSConfig(path="/tmp/ctx-test", backend="local", mode="binding-client")
...
async def ctx_fs_binding_instance():
...
class TestVikingFSBindingLocal:
    ...
    async def test_file_operations(self, ctx_fs_binding_instance):
        """Test VikingFS file operations: read, write, ls, stat."""
        vfs = ctx_fs_binding_instance
    ...
    async def test_directory_operations(self, ctx_fs_binding_instance):
    ...
    async def test_tree_operations(self, ctx_fs_binding_instance):
    ...
    async def test_binary_operations(self, ctx_fs_binding_instance):
