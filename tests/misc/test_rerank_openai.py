...
from atom_ctx_cli.utils.config.rerank_config import RerankConfig
from atom_ctx_cli.utils.rerank import RerankClient
from atom_ctx_cli.utils.rerank_openai import OpenAIRerankClient
...
class TestOpenAIRerankClient:
    ...
    def test_rerank_batch_success(self):
        ...
        with patch("atom_ctx_cli.utils.rerank_openai.requests.post", return_value=mock_response):
    ...
    def test_rerank_batch_http_error_returns_none(self):
        ...
        with patch(
            "atom_ctx_cli.utils.rerank_openai.requests.post",
    ...
    def test_rerank_batch_sends_correct_request(self):
        ...
        with patch(
            "atom_ctx_cli.utils.rerank_openai.requests.post", return_value=mock_response
        ) as mock_post:
