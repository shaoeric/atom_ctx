...
def _make_ctx_fs():
    ...
    fs._uri_prefix = "ctx://"
    fs._bound_ctx = contextvars.ContextVar("ctxfs_bound_ctx", default=None)
    return fs
...
class TestMkdir:
    ...
    async def test_mkdir_calls_agfs_mkdir(self):
        ...
        await fs.mkdir("ctx://resources/new_dir")
    ...
    async def test_mkdir_exist_ok_true_existing(self):
        ...
        await fs.mkdir("ctx://resources/existing_dir", exist_ok=True)
    ...
    async def test_mkdir_exist_ok_true_not_existing(self):
        ...
        await fs.mkdir("ctx://resources/new_dir", exist_ok=True)
    ...
    async def test_mkdir_exist_ok_false_default(self):
        ...
        await fs.mkdir("ctx://resources/another_dir")
