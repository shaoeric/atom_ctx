...
class TestSessionCreate:
    ...
    async def test_create_new_session(self, client: AsyncAtomCtx):
    ...
    async def test_create_with_id(self, client: AsyncAtomCtx):
    ...
    async def test_create_multiple_sessions(self, client: AsyncAtomCtx):
...
class TestSessionLoad:
    ...
    async def test_load_nonexistent_session(self, client: AsyncAtomCtx):
...
class TestSessionMustExist:
    ...
    async def test_must_exist_raises_for_nonexistent(self, client: AsyncAtomCtx):
    ...
    async def test_must_exist_succeeds_after_create(self, client: AsyncAtomCtx):
    ...
    async def test_must_exist_false_default_accepts_unknown_id(self, client: AsyncAtomCtx):
...
class TestSessionExists:
    ...
    async def test_session_exists_true_after_create(self, client: AsyncAtomCtx):
    ...
    async def test_session_exists_false_for_unknown(self, client: AsyncAtomCtx):
