...
class TestAddResource:
    ...
    async def test_add_resource_success(self, client: AsyncAtomCtx, sample_markdown_file: Path):
    ...
    async def test_add_resource_with_wait(
        self, client: AsyncAtomCtx, sample_markdown_file: Path
    ):
    ...
    async def test_add_resource_with_to(self, client: AsyncAtomCtx, sample_markdown_file: Path):
    ...
    async def test_add_resource_file_not_found(self, client: AsyncAtomCtx):
...
class TestWaitProcessed:
    ...
    async def test_wait_processed_empty_queue(self, client: AsyncAtomCtx):
    ...
    async def test_wait_processed_multiple_resources(
        self, client: AsyncAtomCtx, sample_files: list[Path]
    ):
...
class TestWatchIntervalParameter:
    ...
    async def test_watch_interval_default_value(
        ...
        with patch.object(
            ...
            mock_add_resource.return_value = {"root_uri": "ctx://test"}
    ...
    async def test_watch_interval_propagates_to_local_client(
        ...
        """Test that watch_interval propagates from AsyncAtomCtx to LocalClient"""
        from atom_ctx.client import LocalClient
