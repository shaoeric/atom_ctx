 ...
 *
 * Activation: ATOM_CTX_DEBUG=1 env var  OR  claude_code.debug: true in ctx.conf.
 * Log path:   ATOM_CTX_DEBUG_LOG env var OR  ~/.ctx/logs/cc-hooks.log.
 ...
 *        Pass a config object directly (avoids re-loading ctx.conf in test scripts).
